...
export const Navigation = () => {
  ...
  const avatarImage = () => {
    //função para pegar o avatar que o usuario escolheu.
      ...
      <div className="container-navigation">
        <ul>
          ...
          {mobile ? (
            <li>
              {' '}
              {/* if para decidir como será renderizado o icone de entra na reunião , no mobile com click, no desktop sem click.*/}
              <img
                src={getIcon('room')}
