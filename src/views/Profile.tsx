  ...
  const finishUpdate = async () => {
    try {
      ...
      if (e?.response?.data?.message) {
        console.log(
          'Ocorreu erro ao atualizar dados do usuário:',
  ...
  return (
    <>
      ...
      <div className="container-profile">
        <ActioHeader actionCallBack={finishUpdate} disabled={!name} />{' '}
        {/*vai deixar o botão de concluir desabilitado se o nome não estiver preenchido no input*/}
